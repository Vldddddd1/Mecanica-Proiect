...
public class MyFrame extends Application {
    private Double[] sineparams = new Double[8];
    ...
    public VBox createButton(String valueLabel) {
        ...
        buton.setOnAction(event -> {
            ...
            MoleculeSampleApp molecule = new MoleculeSampleApp(sineparams);

            molecule.start(new Stage());
        });
    ...
    private void runExternalJavaFile() throws IOException {
        ...
        String classpath = "C:\\Users\\vlddd\\IdeaProjects\\MoleculeSampleApp\\out\\production\\MoleculeSampleApp\\moleculesampleapp"; // Replace with the absolute path to your class directory
        String className = "moleculesampleapp/MoleculeSampleApp"; // Replace with the fully qualified name of your class
